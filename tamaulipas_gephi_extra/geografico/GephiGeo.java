...
/** args: input.gexf outDir   (node attributes lat, lon, total_kg, community) */
public class GephiGeo {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Column communityColumn = findColumnByTitle(nodeTable, "community");
        ...
        double meanLat = Math.toRadians(24.5);
        ...
        previewModel.getProperties().putValue(PreviewProperty.NODE_LABEL_FONT, new Font("Arial", Font.PLAIN, 13));
        ...
        try {
            ...
            pngExporter.setWidth(1200);
            pngExporter.setHeight(1600);
